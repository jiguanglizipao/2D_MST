...
Perimeter::Perimeter(Node * parent): QGraphicsObject(parent),
    m_node(parent), m_radius(s_minRadius)
{
...
void Perimeter::paint(QPainter * painter,
...
void Perimeter::mouseReleaseEvent(QGraphicsSceneMouseEvent * event)
{
    ...
    if ((!s_mouseWasDragged)
        && (event->button() & View::getSelectionButton())) {
