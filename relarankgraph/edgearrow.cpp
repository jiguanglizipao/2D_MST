...
EdgeArrow::EdgeArrow(BaseEdge * edge): QGraphicsObject(edge),
    m_edge(edge), m_arrowPolygon(QPolygonF()), m_kind(ArrowKind::SINGLE),
    m_label(nullptr)
{
...
void EdgeArrow::paint(QPainter * painter,
