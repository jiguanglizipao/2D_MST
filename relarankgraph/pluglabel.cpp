...
PlugLabel::PlugLabel(Plug * parent): QGraphicsItem(parent),
    m_plug(parent), m_isHighlighted(false)
{
...
void PlugLabel::updateShape()
{
    ...
    m_boundingRect =
        m_transform.
        mapRect(QRectF(0, 0, textSize.width(), textSize.height()));
}
...
void PlugLabel::paint(QPainter * painter,
                      ...
                      QWidget * /*widget */)
{
    ...
    painter->
    setPen(QPen(m_isHighlighted ? Plug::getHighlightColor() : s_color));
